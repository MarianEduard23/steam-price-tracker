...
def main():
    ...
    items = [
        ...
        {'name': 'AK-47 | Aphrodite (Well-Worn)',                        'quantity': 1},
        {'name': 'AWP | Ice Coaled (Minimal Wear)',                      'quantity': 1},
        {'name': 'M4A1-S | Black Lotus (Factory New)',                   'quantity': 1},
        {'name': 'Desert Eagle | Mulberry (Factory New)',                'quantity': 1},
        {'name': 'MAC-10 | Disco Tech (Minimal Wear)',                   'quantity': 1},
        {'name': 'P2000 | Acid Etched (Factory New)',                    'quantity': 1},
        {'name': 'P90 | Wave Breaker (Factory New)',                     'quantity': 1},
        {'name': 'FAMAS | 2A2F (Factory New)',                           'quantity': 1},
        {'name': 'AUG | Aristocrat (Factory New)',                       'quantity': 1},
        {'name': 'M4A4 | Tooth Fairy (Minimal Wear)',                    'quantity': 1},
        {'name': 'Glock-18 | Shinobu (Minimal Wear)',                    'quantity': 1},
        {'name': 'MP7 | Fade (Factory New)',                             'quantity': 1},
        {'name': 'MP9 | Mount Fuji (Minimal Wear)',                      'quantity': 1},
        {'name': 'Nova | Rising Sun (Factory New)',                      'quantity': 5},
        {'name': "'Two Times' McCoy | TACP Cavalry",                     'quantity': 1},
        {'name': 'Bloody Darryl The Strapped | The Professionals',       'quantity': 1},
        {'name': "Chef d'Escadron Rouchard | Gendarmerie Nationale",     'quantity': 1},
        {'name': "Prof. Shahmat | Elite Crew",                           'quantity': 1},
        {'name': 'Clutch Case',                                          'quantity': 50},
        {'name': 'Prisma 2 Case',                                        'quantity': 50},
        {'name': 'Gallery Case',                                         'quantity': 200},
        {'name': 'Danger Zone Case',                                     'quantity': 5},
        {'name': 'Operation Breakout Weapon Case',                       'quantity': 10},
        {'name': 'Fever Case',                                           'quantity': 500},
        ...
        {'name': 'Austin 2025 Contenders Sticker Capsule',               'quantity': 100},
        {'name': 'Austin 2025 Legends Sticker Capsule',                  'quantity': 100},
        {'name': 'MP9 | Nexus (Field-Tested)',                           'quantity': 57},
        {'name': 'MAG-7 | Resupply (Field-Tested)',                      'quantity': 37},
        {'name': 'XM1014 | Mockingbird (Field-Tested)',                  'quantity': 5},
        {'name': '2021 Community Sticker Capsule',                       'quantity': 10},
        {'name': 'Community Sticker Capsule 1',                         'quantity': 5},
        {'name': 'Souvenir Charm | Austin 2025 Highlight | 1 Bullet',   'quantity': 1},
        {'name': 'Sticker | torzsi (Gold) | Shanghai 2024',             'quantity': 1},
        {'name': 'Sticker | iM (Holo) | Paris 2023',                    'quantity': 1},
        {'name': 'Sticker | iM (Gold) | Paris 2023',                    'quantity': 1},
        {'name': 'Sticker | TRAVIS (Holo) | Copenhagen 2024',           'quantity': 2},
        {'name': 'Sticker | Natus Vincere (Holo) | Shanghai 2024',      'quantity': 1},
        {'name': 'Sticker | Perfecto (Holo) | Paris 2023',              'quantity': 1},
        {'name': 'Sticker | Queen Ava (Foil)',                           'quantity': 1},
        {'name': 'Sticker | b1t (Holo) | Paris 2023',                   'quantity': 1},
        {'name': 'Sticker | Imperial Esports (Glitter) | Copenhagen 2024', 'quantity': 2},
        {'name': 'Sticker | Flex',                                       'quantity': 2},
        {'name': 'Sticker | Ribbon Tie',                                 'quantity': 1},
        {'name': 'Sticker | Complexity Gaming (Foil) | Austin 2025',    'quantity': 3},
        {'name': 'Sticker | Quick Peek',                                 'quantity': 100},
        {'name': 'Sticker | Taste Bud',                                  'quantity': 20},
        {'name': 'Sticker | Overloaded (Glitter)',                       'quantity': 1},
        {'name': 'Sticker | Bolt Strike',                                'quantity': 2},
        {'name': 'Sticker | Boom Blast (Glitter)',                       'quantity': 1},
        {'name': 'Sticker | Heroic (Gold) | 2020 RMR',                  'quantity': 1},
        {'name': 'Sticker | Fly High',                                   'quantity': 15},
        {'name': 'Sticker | Hydro Stream',                               'quantity': 1},
        {'name': 'Sticker | Hot Rod Heat',                               'quantity': 1},
        {'name': 'Sticker | Hydro Geyser',                               'quantity': 1},
        {'name': 'Sticker | iM (Glitter, Champion) | Copenhagen 2024',  'quantity': 20},
        ...
        {'name': 'Sticker | From The Deep (Glitter)',                    'quantity': 20},
        {'name': 'Sticker | Chompers',                                   'quantity': 1},
        {'name': 'Sticker | Heroic (Holo) | 2020 RMR',                  'quantity': 20},
        {'name': 'Sticker | Ninjas in Pyjamas (Holo) | 2020 RMR',       'quantity': 25},
        {'name': 'Sticker | Scorch Loop',                                'quantity': 25},
        {'name': 'Sticker | Boom Epicenter (Glitter)',                   'quantity': 25},
        {'name': 'Sticker | Bolt Energy',                                'quantity': 50},
        {'name': 'Sticker | Hydro Stream',                               'quantity': 100},
        {'name': 'Sticker | Bomb Planted (Holo)',                        'quantity': 4},
        {'name': 'Sticker | M80 (Foil) | Austin 2025',                  'quantity': 10},
        {'name': 'Sticker | FaZe Clan (Foil) | Austin 2025',            'quantity': 20},
        {'name': 'Sticker | iM (Foil) | Austin 2025',                   'quantity': 100},
        {'name': 'Sticker | NiKo | Paris 2023',                         'quantity': 200},
        {'name': 'Sticker | RED Canids (Gold) | Budapest 2025',         'quantity': 2},
        {'name': 'Sticker | fnatic (Gold) | Budapest 2025',             'quantity': 1},
        {'name': 'Sticker | FaZe Clan (Embroidered) | Budapest 2025',   'quantity': 3},
        {'name': 'Sticker | iM (Glitter) | Copenhagen 2024',            'quantity': 50},
    ]
